// src/components/EmergencyServices.jsx
...
//   // memo map center: selected garage else user coords else default
//   const mapCenter = useMemo(() => {
//     if (selectedGarage && selectedGarage.location?.coordinates) {
//       return {
...
//         Emergency Services — Garages Map
//       </h1>
...
//           <div
//             id="emergency-map"
//             style={{ height: "520px", borderRadius: 10, overflow: "hidden" }}
//           >
//             <MapContainer
...
//                     if (userCoords) setSelectedGarage(null);
//                     else alert("User location not available.");
//                   }}
//                 >
//                   Center on me
//                 </button>
...
//             {loading && <div className="p-3">Loading garages...</div>}
//             {error && <div className="p-3 text-red-600">{error}</div>}
//             {!loading && filtered.length === 0 && (
//               <div className="p-3">No garages found.</div>
//             )}
...
//                 <div
//                   key={g._id || `${lat}-${lng}`}
//                   className={`p-3 mb-2 border rounded cursor-pointer hover:shadow ${
//                     selectedGarage && selectedGarage._id === g._id
//                       ? "bg-blue-50"
//                       : "bg-white"
//                   }`}

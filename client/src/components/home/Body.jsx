...
const Body = () => {
  const [reviews, setReviews] = useState([
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Super fast and professional. Very clean garage and polite staff.",
    },
  ]);
      ...
      <section className="relative bg-gradient-to-br from-blue-500 to-indigo-600 text-white py-40 md:py-40 overflow-hidden">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Your one-stop destination for expert car care, emergency repairs,
            and trusted local service.
          </p>
      ...
      <section className="py-20 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            We combine technology, expertise, and care to keep your vehicle
          ...
          {[
            {
              ...
              desc: "Certified professionals ready to handle all types of repairs.",
            },
            {
              icon: Clock,
              title: "Fast & Reliable",
              desc: "Quick turnaround so you can get back on the road faster.",
            },
            {
              icon: Users,
              title: "Customer First",
              desc: "Transparent service trusted by hundreds of customers.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-6 text-lg">
              Our emergency mechanics are always ready to help — anytime,
              anywhere.
            </p>
